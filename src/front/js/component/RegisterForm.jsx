        ...
        <>
            ...
            <form className='d-flex p-5 rouded flex-column gap-4 fs-5 align-items-start fw-bold' style={{ background: '#0b3b66', borderRadius: '10px' }} onSubmit={handleSubmit}>
                ...
                <div className=''>
                    ...
                    <input className='ms-2 rounded p-2' style={{ outline: 'none', background: `${colorInput}`, border: 'none', caretColor: '#37d33c', color: '#06f50e' }} type="text" id='user_name' required autoComplete='off' />
                </div>
                <div className=''>
                    <label htmlFor="fist_name" style={{minWidth: '110px'}}>First Name: </label>
                    <input className='ms-2 rounded p-2' style={{ outline: 'none', background: `${colorInput}`, border: 'none', caretColor: '#37d33c', color: '#06f50e' }} type="text" id='first_name' required autoComplete='off' />
                </div>
                <div>
                    <label htmlFor="last_name" style={{minWidth: '110px'}}>Last Name: </label>
                    <input className='ms-2 rounded p-2' style={{ outline: 'none', background: `${colorInput}`, border: 'none', caretColor: '#37d33c', color: '#06f50e' }} type="text" id='last_name' required autoComplete='off' />
                </div>
                <div>
